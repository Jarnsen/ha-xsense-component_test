...
def test_existing_camera_video_transceiver_prefers_bridge_decodable_h264_profile():
    class FakeTrack:
        kind = "video"
...
async def test_camera_offer_constrains_camera_leg_to_bridge_decodable_h264():
