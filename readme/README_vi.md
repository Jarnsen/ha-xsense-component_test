...
Camera được hỗ trợ mặc định dùng X-Sense stream source ổn định cho chế độ xem trực tiếp trong Home Assistant với video và âm thanh khi camera/tài khoản cung cấp. Cầu nối X-Sense WebRTC thử nghiệm có thể bật trong tùy chọn tích hợp để kiểm thử và sẽ bật debug logs. Camera cũng tạo các thực thể sự kiện `Motion` và `AI Detection`.
...
[![Nhập blueprint](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fraw.githubusercontent.com%2FJarnsen%2Fha-xsense-component_test%2Fmain%2Fblueprints%2Fautomation%2Fxsense%2Fcamera_ai_notification.yaml)
...
- Xem trực tiếp camera mặc định dùng X-Sense stream source ổn định; cầu nối X-Sense WebRTC thử nghiệm chỉ được dùng khi chọn trong tùy chọn tích hợp để kiểm thử.
