...
اگر هنوز از نسخه قدیمی `v1.2.6.x` استفاده می‌کنید، قبل از ارتقای Home Assistant Core به 2026.7 یا جدیدتر، به `v1.3.14` یا جدیدتر بروزرسانی کنید. نسخه‌های قدیمی به `aiortc` نیاز داشتند که با Python 3.14 در Home Assistant سازگار نیست. نسخه‌های فعلی `v1.3.x` دیگر به `aiortc` نیاز ندارند.
