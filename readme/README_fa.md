...
- **سایر دستگاه‌های متصل به ایستگاه**: چراغ، کی‌پد، صندوق پستی، دستگاه شنونده، هشدار مسیر، Smart Drop، ریموت و داده‌های رادون وقتی API فیلدهای پشتیبانی‌شده را گزارش کند نمایش داده می‌شوند.
...
- سنسورهای باتری، سیگنال RF، سیگنال Wi-Fi، فریمور، دما، رطوبت، سطح CO، اوج CO، حجم صدای هشدار، حجم صدا، حجم چرپ، حجم یادآور، آستانه‌های هشدار، تایمرهای بی‌صدا، زمان‌های خوانا، منطقه زمانی، شماره سریال، نشانی MAC و داده‌های تشخیصی دیگر.
