...
وقتی یک رویداد Motion شامل داده پخش X-Sense باشد، یکپارچه‌سازی می‌تواند ابتدا کلیپ را در کش ذخیره کند و سپس اعلان موبایلی بفرستد که همان کلیپ را در X-Sense Recordings باز می‌کند. اگر یک اعلان ساده حرکت بدون انتظار برای ویدئو می‌خواهید، لینک‌های ضبط را در blueprint خاموش کنید. همگام‌سازی رسانه ضبط می‌تواند کلیپ‌های جدید را در پس‌زمینه آماده نگه دارد و blueprintهای قدیمی دوربین X-Sense به‌صورت خودکار به‌روزرسانی می‌شوند.
