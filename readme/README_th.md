...
หากคุณยังใช้บิลด์เก่า `v1.2.6.x` ให้อัปเดตเป็น `v1.3.14` หรือใหม่กว่าก่อนอัปเกรด Home Assistant Core เป็น 2026.7 หรือใหม่กว่า บิลด์เก่าต้องใช้ `aiortc` ซึ่งไม่เข้ากันกับ Python 3.14 runtime ของ Home Assistant บิลด์ `v1.3.x` ปัจจุบันไม่ต้องใช้ `aiortc` แล้ว
