...
Podporované kamery výchozí používají stabilní X-Sense stream source pro živý náhled v Home Assistantu s videem a zvukem, pokud jej kamera/účet poskytuje. Experimentální X-Sense WebRTC bridge lze zapnout v možnostech integrace pro testování a zapne debug logy. Kamery vytvářejí event entity `Motion` a `AI Detection`.
...
[![Importovat blueprint](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fraw.githubusercontent.com%2FJarnsen%2Fha-xsense-component_test%2Fmain%2Fblueprints%2Fautomation%2Fxsense%2Fcamera_ai_notification.yaml)
...
Podporované kamery mohou poskytovat entitu kamery, náhledy, živý stream, stav připojení a nastavení dostupná v aplikaci X-Sense. Živý náhled kamery ve výchozím stavu používá stabilní X-Sense stream source; experimentální X-Sense WebRTC bridge se použije jen při výběru v možnostech integrace pro testování.
...
- Živý náhled kamery používá stabilní X-Sense stream source ve výchozím stavu; experimentální X-Sense WebRTC bridge je jen pro testování v možnostech integrace.
