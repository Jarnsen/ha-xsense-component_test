...
Podporované kamery mohou poskytovat entitu kamery, náhledy, živý stream, stav připojení a nastavení dostupná v aplikaci X-Sense. Pokud je v Home Assistantu dostupná cesta WebRTC, může ji integrace použít pro vhodný živý náhled.
