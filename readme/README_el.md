...
Όταν ένα συμβάν Motion περιέχει μεταδεδομένα αναπαραγωγής X-Sense, η ενσωμάτωση προσπαθεί να αποθηκεύσει αμέσως το κλιπ στην cache. Όταν το αρχείο είναι έτοιμο, η ειδοποίηση χρησιμοποιεί το `recording_media_url` για αναπαραγωγή βίντεο· διαφορετικά το `recording_url` ανοίγει το X-Sense Recordings viewer στο Home Assistant. Οι χειροκίνητες εκτελέσεις αυτοματισμού χρησιμοποιούν τα πιο πρόσφατα δεδομένα εγγραφής της επιλεγμένης οντότητας συμβάντος, επομένως η ειδοποίηση εγγραφής αποστέλλεται μόνο αφού αυτή η οντότητα λάβει πραγματικό σύνδεσμο εγγραφής. Το Recording media sync μπορεί να ετοιμάζει πρόσφατα κλιπ στο παρασκήνιο.
