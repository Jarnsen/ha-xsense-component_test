...
Ha egy Motion esemény X-Sense lejátszási metaadatokat tartalmaz, az integráció azonnal megpróbálja cache-elni a klipet. Ha a fájl elkészült, az értesítés a videólejátszáshoz a `recording_media_url` értéket használja; egyébként a `recording_url` megnyitja az X-Sense Recordings nézetet a Home Assistantban. A kézi automatizációfuttatások a kiválasztott eseményentitás legutóbbi felvételi adatait használják, ezért felvételi értesítést csak akkor küldenek, ha az entitás már kapott valódi felvételi linket. A Recording media sync a friss klippeket háttérben is előkészítheti.
