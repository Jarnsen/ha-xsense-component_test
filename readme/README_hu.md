...
A támogatott kamerák alapból a stabil X-Sense stream source útvonalat használják Home Assistant élőképhez videóval és hanggal, ha a kamera/fiók ezt biztosítja. A kísérleti X-Sense WebRTC híd teszteléshez bekapcsolható az integráció beállításaiban, és bekapcsolja a debug naplózást. A kamerák `Motion` és `AI Detection` esemény entitásokat hoznak létre.
...
[![Blueprint importálása](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fraw.githubusercontent.com%2FJarnsen%2Fha-xsense-component_test%2Fmain%2Fblueprints%2Fautomation%2Fxsense%2Fcamera_ai_notification.yaml)
...
A támogatott kamerák kameraentitást, bélyegképeket, élő közvetítést, kapcsolati állapotot és az X-Sense alkalmazással összhangban lévő beállításokat biztosíthatnak. A kamera élőkép alapértelmezetten a stabil X-Sense stream source útvonalat használja; a kísérleti X-Sense WebRTC híd csak akkor használatos, ha teszteléshez kiválasztják az integráció beállításaiban.
...
- A kamera élőkép alapértelmezetten a stabil X-Sense stream source útvonalat használja; a kísérleti X-Sense WebRTC híd csak teszteléshez választható ki az integráció beállításaiban.
