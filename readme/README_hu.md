...
Ha egy Motion esemény X-Sense lejátszási adatokat tartalmaz, az integráció először gyorsítótárba teheti a klipet, majd mobil értesítést küldhet, amely a megfelelő klipet nyitja meg az X-Sense Recordings nézetben. Kapcsold ki a felvétellinkeket a blueprintben, ha egyszerű mozgásértesítést szeretnél videóra várás nélkül. A felvételmédia-szinkronizálás a friss klipeket háttérben előkészítheti, a régebbi importált X-Sense kamera blueprint-ek pedig automatikusan frissülnek.
