...
- Supported cameras expose AI notification detections through Home Assistant event entities, with last-detection sensors available for recent person, pet, vehicle, package, and other detection history when the camera reports those events.
...
### Camera AI Notifications / Kamera-KI-Benachrichtigungen
