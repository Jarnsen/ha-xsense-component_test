...
- The integration bundles the reviewed `wheemer-python-xsense` package snapshot for its X-Sense API client so the reusable client code can stay aligned with the standalone library without installing a direct wheel at Home Assistant startup.
